           ...
           <section className="w-full py-6 md:py-24 lg:py-32 ">
                <div className="container mx-auto px-4 md:px-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                      ...
                      <Card
                      className="border-2 hover:border-primary  duration-100 hover:scale-90 transform transition  rounded-lg"
                    >
                    ...
                    <Card
                      className="border-2 hover:border-primary  duration-300 hover:scale-90 transform transition  rounded-lg"
                    >
                      <CardContent className="pt-6 text-center flex flex-col items-center">
                        <div className="flex flex-col items-center justify-center">
                          <Link href="/">
                    ...
                    <Card
                      className="border-2 hover:border-primary  duration-300 hover:scale-90 transform transition  rounded-md"
                    >
                      <CardContent className="pt-6 text-center flex flex-col items-center">
                        <div className="flex flex-col items-center justify-center">
                          <Link href="/">
                          ...
                          <h3 className="text-xl font-bold mb-2">Shyam ji Tiwari</h3>
                          <p className="text-xl font-light mb-2">(Developer)</p>
                          <p className="text-muted-foreground">
